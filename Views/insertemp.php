...
<head>
    ...
    <link rel="stylesheet" href="../Views/Css/RegisterEmp.css">
...
<header class="header">
    ...
    <div class="contend">
  <form  action="EmpresaController.php" method="POST" enctype="multipart/form-data" class="form-register" id="formUser">
      <h4>Registro Empresas</h4>
      <input class="controls" type="hidden" name="action" value="insertemp">
      <input class="controls" type="text" name="nom_emp" placeholder="Nombre de la empresa" required/>
      <input class="controls" type="text" name="email"  placeholder="Email" required/>
      <input class="controls" type="number" name="nit" placeholder="Nit" required/>
      ...
      <div class="text-ini">
        <a href="http://localhost:8080/EmplimaxMVC/Controller/EmpresaController.php?action=loginemp">¿Ya tiene una cuenta?</a>
