...
<div class="well well-sm text-right">
    <a class="btn btn-primary" href="http://localhost:8080/EmplimaxMVC/Controller/persona.controller.php?action=CrudView">Ver Persona</a>
</div>
						</div>	
					</div>		
				</div>		
