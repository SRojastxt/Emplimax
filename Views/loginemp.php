...
<head>
    ...
    <title>Inicio de sesión: Empresa</title>
...
<div class="form-cont">
            ...
            <section class="cont-init">
                <div class="campos">
                    <div class="camp">
                        <label for="User"> Nombre de la Empresa </label>
                        <input type="text" name="nom_emp" placeholder="Nombre de la Empresa" required />
                    </div>
                    <div class="camp-2">
